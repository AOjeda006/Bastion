...
public sealed class DivisasController(
    ...
    IModificarDivisa modificar,
    IRetirarDivisa retirar,
    IReincorporarDivisa reincorporar) : ControladorDeOrganizacion
{
    ...
    /// <summary>Retira una divisa: deja de ofrecerse para operaciones nuevas (ADR-0023).</summary>
    /// <remarks>
    ...
    [ExigePermiso(PermisosDeOrganizacion.DivisaRetirar)]
    ...
    [ExigePermiso(PermisosDeOrganizacion.DivisaReincorporar)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status412PreconditionFailed)]
    [ProducesResponseType(StatusCodes.Status428PreconditionRequired)]
