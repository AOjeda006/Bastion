...
namespace Bastion.Organizacion.Infrastructure.Migrations
{
    ...
    [Migration("20260923183741_UnaFechaCaeEnUnSoloEjercicio")]
    partial class UnaFechaCaeEnUnSoloEjercicio
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bastion.Organizacion.Domain.Series.ContadorDeSerie", b =>
                {
                    ...
                    b.HasKey("SerieId")
                        .HasName("pk_contadores_de_serie");

                    b.ToTable("contadores_de_serie", "organizacion");

                    b.HasAnnotation("Bastion:Auditoria", "NoAuditada|lo escribe la sentencia de numeración en crudo, que no pasa por el rastreador de cambios: auditarlo sería prometer una traza que el mecanismo no puede escribir. El rastro del número es el documento que lo lleva");
                });
            ...
            modelBuilder.Entity("Bastion.Organizacion.Domain.Series.ContadorDeSerie", b =>
                {
                    b.HasOne("Bastion.Organizacion.Domain.Series.Serie", null)
                        .WithOne("Numeracion")
                        .HasForeignKey("Bastion.Organizacion.Domain.Series.ContadorDeSerie", "SerieId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired()
                        .HasConstraintName("fk_contadores_de_serie_series_serie_id");
                });
