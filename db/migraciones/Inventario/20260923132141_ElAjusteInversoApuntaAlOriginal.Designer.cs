...
namespace Bastion.Inventario.Infrastructure.Migrations
{
    ...
    [Migration("20260923132141_ElAjusteInversoApuntaAlOriginal")]
    partial class ElAjusteInversoApuntaAlOriginal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bastion.Inventario.Domain.Ajustes.Ajuste", b =>
                {
                    ...
                    b.Property<Guid?>("AnulaAId")
                        .HasColumnType("uuid")
                        .HasColumnName("anula_a_id")
                        .HasAnnotation("Bastion:Auditoria", "Auditada|");
                    ...
                    b.HasIndex("AnulaAId")
                        .HasDatabaseName("ix_ajustes_anula_a_id");
            ...
            modelBuilder.Entity("Bastion.Inventario.Domain.Ajustes.Ajuste", b =>
                {
                    b.HasOne("Bastion.Inventario.Domain.Ajustes.Ajuste", null)
                        .WithMany()
                        .HasForeignKey("AnulaAId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ajustes_ajustes_anula_a_id");
                });
