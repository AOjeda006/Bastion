 ...
 *
 * **El tipo viaja por `import type` y el valor por `import()`.** No es un adorno de estilo: es lo
 * único que hace que esto funcione. Un import mezclado —`import { es, type Diccionario } from
 ...
 * DESAPARECE —no encoge: deja de existir—, el fragmento de entrada pasa de 384,8 kB a 403,3 kB y el
 * arranque que mide la CI, de 391 a 409 KiB. Es decir: se queda exactamente como estaba, con la
 * importación dinámica escrita y sin efecto.
 *
